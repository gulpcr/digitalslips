...
class Settings(BaseSettings):
    ...
    SMTP_PASSWORD: str = ""
    SMTP_FROM: str = ""
    SMTP_FROM_NAME: str = "eDimensionz - Precision Receipt"
    
    # OpenAI (for Cheque OCR)
    OPENAI_API_KEY: str = ""
    ...
    # Public URL (for WhatsApp media - use ngrok URL or deployed URL)
    PUBLIC_URL: str = ""  # e.g., https://abc123.ngrok.io or https://yourdomain.com
